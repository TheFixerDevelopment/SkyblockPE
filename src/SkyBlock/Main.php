...
class Main extends PluginBase {
    ...
    public function onEnable() {
        ...
        $this->getLogger()->info(TextFormat::AQUA . TextFormat::BOLD . "[" . TextFormat::GREEN . "SkyBlockPE" . TextFormat::AQUA . "] " . TextFormat::RESET . TextFormat::DARK_GREEN . "Skyblock by Zeao has been Enabled. You're using the official v1.0.0 version of this plugin. This branch you have chosen is specifically for no spoon users. Enjoy.");
    }

    public function onDisable() {
        $this->getLogger()->info(TextFormat::AQUA . TextFormat::BOLD . "[" . TextFormat::GREEN . "SkyBlockPE" . TextFormat::AQUA . "] " . TextFormat::RESET . TextFormat::DARK_GREEN . "Skyblock by Zeao has been Disabled");
    }

...
class Main extends PluginBase {
    ...
    public function onEnable() {
        ...
        $this->getLogger()->info(TextFormat::AQUA . TextFormat::BOLD . "[" . TextFormat::GREEN . "SkyBlockPE" . TextFormat::AQUA . "] " . TextFormat::RESET . TextFormat::DARK_GREEN . "Skyblock by Zeao has been Enabled. You're using the Public version of this plugin. Enjoy.");
    }
